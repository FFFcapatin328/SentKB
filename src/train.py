...
if __name__ == '__main__':
    ...
    parser.add_argument('--senti_flag', type=bool, default=False, help='use sentiment features or not')
    parser.add_argument('--graph_flag', type=bool, default=False, help='use graph features or not')
    parser.add_argument('--summa_flag', type=bool, default=False, help='use text summarization or not')
